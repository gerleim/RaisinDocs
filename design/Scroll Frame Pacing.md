...
artifact. See `design/_done/Scroll Pre-Buffering.md`.
...
- The prototype measurements in C1-C3 stand. A paced swapchain does present at 3.57 ms with 0%
  ...
  `design/_done/Opaque Line Visuals.md`.
...
investigation began from. See `design/_done/Scroll Pre-Buffering.md`.

What still stands from C1-C3: the prototype numbers, the ClearType finding that set off
`design/_done/Opaque Line Visuals.md`, and [dotnet/wpf#11607](https://github.com/dotnet/wpf/discussions/11607)
